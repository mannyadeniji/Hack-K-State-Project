...
// Display list of all users's public repos
const displayRepos = (repos) => {
  ...
  for (const repo of repos) {
    ...
    const langUrl = `${userHome}?tab=repositories&q=&language=${repo.lanuage}`;
    //const starsUrl = ``
    //const forksUrl = ``
...
filterInput.addEventListener("input", (e) => {
  ...
  for (const repo of repos) {
    ...
    if (lowerText.inclides(searchLowerText)) {
